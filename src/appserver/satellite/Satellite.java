...
public class Satellite extends Thread {
    ...
    public Satellite(String satellitePropertiesFile, 
        ...
        try {
        	...
        	// no config file
        	System.err.println("[Satellite.constructor] CAUGHT -- IO Exception\n"+e); 
        	System.exit(1);
        }
        ...
        public void run() {
            ...
            switch (message.getType()) {
                case JOB_REQUEST:
                	...
                	System.out.println("[SatelliteThread.run] Tool: " + toolType); 
                	
                	// Tell client the results //TODO
                	try {
                		tool = getToolObject (toolType); 
                	} catch (IllegalAccessException | ClassNotFoundException 
                				| InstantiationException | UnknownToolException e) {
                		System.err.println("[SatelliteThread.run] Problem occured during "
                								+ "getToolObject()....." + e); 
                		System.exit(1);
                	}
                    break;
